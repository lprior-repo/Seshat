...
fn assert_terminal_shape_parses_to(input: &str, expected: crate::document::ArrowType) {
...
fn assert_terminal_shape_serializes_to(arrow_type: crate::document::ArrowType, expected: &str) {
...
fn assert_terminal_shape_returns_error(invalid_input: &str) {
    ...
    assert_eq!(result, crate::document::ArrowType::Default);
}
