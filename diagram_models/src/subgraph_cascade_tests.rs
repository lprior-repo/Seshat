...
mod tests {
    ...
    use crate::projection::ops::group_ops::apply_ungroup;
    use crate::projection::types::DiagramProjection;

    use crate::subgraph_events::types::DiagramState;
    use im::HashMap;
    use rand::prelude::*;
    ...
    /// This test uses REAL production code: `apply_ungroup` from `crate::projection::ops::group_ops`
