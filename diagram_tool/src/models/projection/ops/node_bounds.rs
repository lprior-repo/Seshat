...
pub fn apply_node_resize(
    ...
    width: f64,
    height: f64,
) -> Result<DiagramProjection, crate::models::projection::types::ProjectionError> {
    use crate::models::projection::types::ProjectionError;
...
fn validate_dimensions(
    width: f64,
    height: f64,
) -> Result<(), crate::models::projection::types::ProjectionError> {
    use crate::models::projection::types::ProjectionError;
