...
pub async fn load_projection_from_snapshot(
    ...
    let base_projection: crate::models::projection::DiagramProjection = match snapshot_result {
        ...
        None => crate::models::projection::DiagramProjection::default(),
    };
    ...
    let final_projection = rows.into_iter().try_fold(base_projection, |acc, row| {
        ...
        crate::models::projection::apply_event(acc, &event)
