...
pub fn NodeElement(props: NodeElementProps) -> Element {
    ...
    let pointer_class = if rd.kind == NodeKind::Subgraph {
        "pointer-events-none"
    } else {
        ""
    };
    ...
    rsx! {
            div {
                ...
                class: "absolute flex flex-col items-center justify-center cursor-inherit rounded-[10px] {node_state_class} {bg_class} {pointer_class}",
