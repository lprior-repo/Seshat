...
mod tests {
    ...
    fn given_infinity_in_safe_bounds_then_returns_none() {
        ...
        assert!(safe_bounds(f64::INFINITY, 0.0, 100.0, 100.0).is_none());
        assert!(safe_bounds(0.0, f64::NEG_INFINITY, 100.0, 100.0).is_none());
        assert!(safe_bounds(0.0, 0.0, f64::INFINITY, 100.0).is_none());
        assert!(safe_bounds(0.0, 0.0, 100.0, f64::INFINITY).is_none());
    }
    ...
    fn given_all_nan_in_safe_bounds_then_returns_none() {
        ...
        // When: calling safe_bounds
        // Then: returns None
        assert!(safe_bounds(f64::NAN, f64::NAN, f64::NAN, f64::NAN).is_none());
    }
